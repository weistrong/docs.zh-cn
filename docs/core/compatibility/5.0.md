...
- [Blazor：Blazor 应用中已更改路由优先逻辑](aspnet-core/5.0/blazor-routing-logic-changed.md)
...
- [Blazor：JSObjectReference 和 JSInProcessObjectReference 类型是内部类型](aspnet-core/5.0/blazor-jsobjectreference-to-internal.md)
...
- [Blazor：更新的静态 Web 资产的验证逻辑](aspnet-core/5.0/blazor-static-web-assets-validation-logic-updated.md)
...
- [HttpSys：默认情况下禁用客户端证书重新协商](aspnet-core/5.0/httpsys-client-certificate-renegotiation-disabled-by-default.md)
...
- [SignalR：MessagePack 中心协议已变动](aspnet-core/5.0/signalr-messagepack-package.md)
...
- [TextInfo.ListSeparator 值已更改](globalization/5.0/listseparator-value-change.md)
...
- [本机代码无法访问 Windows 窗体对象](windows-forms/5.0/winforms-objects-not-accessible-from-native-code.md)
