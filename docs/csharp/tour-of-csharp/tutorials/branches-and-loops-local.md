...
本教程要求安装一台虚拟机，以用于本地开发。 在 Windows、Linux 或 macOS 上，可以使用 .NET CLI 创建、生成和运行应用程序。 在 Mac 和 Windows 上，可以使用 Visual Studio 2019。 有关创建说明，请参阅[创建本地环境](local-environment.md)。
