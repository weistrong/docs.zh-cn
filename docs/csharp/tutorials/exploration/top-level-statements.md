...
## <a name="build-a-magic-net-answer-machine"></a><span data-ttu-id="98af1-127">构建神奇的 .NET 应答机</span><span class="sxs-lookup"><span data-stu-id="98af1-127">Build a magic .NET answer machine</span></span>
