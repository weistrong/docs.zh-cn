...
- 完全受信任，无需 <xref:System.Security.Policy.StrongName> 证据 (例如，具有 `MyComputer` 区域证据) 。
...
> [!NOTE]
> 如果对计算机上的所有应用程序使用注册表项关闭了绕过功能，则此配置文件设置将不起作用。 有关详细信息，请参阅 [如何：禁用 Strong-Name 绕过功能](../../../../standard/assembly/disable-strong-name-bypass-feature.md)。
