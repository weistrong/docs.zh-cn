...
|`textEncoding`|设置要用来在绑定上发出消息的字符集编码。 有效值包括以下值：<br /><br /> -BigEndianUnicode： Unicode Big Endian 编码。<br />-Unicode：16位编码。<br />-UTF8：8位编码。<br /><br /> 默认编码为 UTF8。 此属性的类型为 <xref:System.Text.Encoding>。|
