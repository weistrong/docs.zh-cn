...
|**DiffGram**|以 DiffGram 形式编写整个 <xref:System.Data.DataSet>，包括原始值和当前值。 有关详细信息，请参阅 [diffgram](diffgrams.md)。|  
 ...
 写入包含 DataRelation 对象的的 XML 表示形式时 <xref:System.Data.DataSet> ，您很可能希望所生成的 xml 将每个关系的子行嵌套在它们的相关父元素中 。 若要实现此目的，请在向添加 **datarelation** 时将 **datarelation** 的 **Nested** 属性设置为 **true** <xref:System.Data.DataSet> 。 有关详细信息，请参阅 [嵌套 datarelation](nesting-datarelations.md)。  
