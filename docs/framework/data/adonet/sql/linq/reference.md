...
## <a name="in-this-section"></a>本节内容  
 ...
 介绍 SQL Server Compact 3.5 与应用程序中 SQL Server 的不同之处 [!INCLUDE[vbtecdlinq](../../../../../../includes/vbtecdlinq-md.md)] 。  
...
## <a name="related-sections"></a>相关章节  
 ...
 描述控件如何 <xref:System.Web.UI.WebControls.LinqDataSource> 通过 ASP.NET 数据源控件体系结构向 Web 开发人员公开 LINQ。
