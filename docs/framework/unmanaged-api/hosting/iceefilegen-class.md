---
description: 了解详细信息： ICeeFileGen 类
title: ICeeFileGen 类
ms.date: 03/30/2017
api_name:
- ICeeFileGen
...
ms.locfileid: "99753960"
---
# <a name="iceefilegen-class"></a><span data-ttu-id="87f13-103">ICeeFileGen 类</span><span class="sxs-lookup"><span data-stu-id="87f13-103">ICeeFileGen Class</span></span>

<span data-ttu-id="87f13-104">提供 (PE) 文件创建本机可移植可执行文件的功能。</span><span class="sxs-lookup"><span data-stu-id="87f13-104">Provides functionality for creating a native portable executable (PE) file.</span></span> <span data-ttu-id="87f13-105">接口通常由编译器用来生成其已编译的输出可执行文件。</span><span class="sxs-lookup"><span data-stu-id="87f13-105">The interface will typically be used by compilers to generate their compiled output executable.</span></span>  
  
> [!NOTE]
> <span data-ttu-id="87f13-106">`ICeeFileGen` 支持 .NET Framework 基础结构，不应在代码中直接使用。</span><span class="sxs-lookup"><span data-stu-id="87f13-106">`ICeeFileGen` supports the .NET Framework infrastructure and is not intended to be used directly from your code.</span></span>  
  
 <span data-ttu-id="87f13-107">此接口已弃用，并将在将来的版本中删除。</span><span class="sxs-lookup"><span data-stu-id="87f13-107">This interface has been deprecated and will be removed in a future release.</span></span>  
  
## <a name="syntax"></a><span data-ttu-id="87f13-108">语法</span><span class="sxs-lookup"><span data-stu-id="87f13-108">Syntax</span></span>  
...
## <a name="requirements"></a><span data-ttu-id="87f13-109">要求</span><span class="sxs-lookup"><span data-stu-id="87f13-109">Requirements</span></span>  

 <span data-ttu-id="87f13-110">**平台：** 请参阅 [系统要求](../../get-started/system-requirements.md)。</span><span class="sxs-lookup"><span data-stu-id="87f13-110">**Platforms:** See [System Requirements](../../get-started/system-requirements.md).</span></span>  
  
 <span data-ttu-id="87f13-111">**标头：** ICeeFileGen</span><span class="sxs-lookup"><span data-stu-id="87f13-111">**Header:** ICeeFileGen.h</span></span>  
  
 <span data-ttu-id="87f13-112">**.NET Framework 版本：** 1。0</span><span class="sxs-lookup"><span data-stu-id="87f13-112">**.NET Framework Version:** 1.0</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="87f13-113">请参阅</span><span class="sxs-lookup"><span data-stu-id="87f13-113">See also</span></span>

- [<span data-ttu-id="87f13-114">承载接口</span><span class="sxs-lookup"><span data-stu-id="87f13-114">Hosting Interfaces</span></span>](hosting-interfaces.md)
