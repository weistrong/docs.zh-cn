...
> [!NOTE]
> 此教程步骤和后续步骤使用 [如何：创建工作流](how-to-create-a-workflow.md)中的所有三个工作流类型。
...
6. 将以下代码添加到 `WorkflowHostForm_Load`。
...
8. 将以下代码添加到 `InstanceId_SelectedIndexChanged`。 只要用户使用组合框选择一个工作流，此处理程序就会更新状态窗口。
