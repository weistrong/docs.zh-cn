...
在下面的示例中，工作流由一个活动组成，其中 <xref:System.Activities.Statements.Sequence> 包含包含活动的子活动 <xref:System.Activities.Statements.TransactionScope> 。 <xref:System.Activities.Statements.TransactionScope.Body%2A> 的 <xref:System.Activities.Statements.TransactionScope> 活动在 <xref:System.Activities.Statements.TransactionScope> 活动初始化的事务下执行。  
...
有关详细信息，请参阅关于使用的详细信息 <xref:System.ServiceModel.Activities.TransactedReceiveScope> ，请参阅将 [事务流入和流出工作流服务](../wcf/feature-details/flowing-transactions-into-and-out-of-workflow-services.md)。  
