...
如果 [Newtonsoft.Json.JsonSerializerSettings](https://www.newtonsoft.com/json/help/html/T_Newtonsoft_Json_JsonSerializerSettings.htm)实例的以下两个条件均为 true，则 *会* 触发此规则：
...
此规则类似于 [CA2327](ca2327.md)，但在这种情况下，分析无法确定设置是否不安全。
