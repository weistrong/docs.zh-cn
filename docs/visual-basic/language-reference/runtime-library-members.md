...
---
# <a name="visual-basic-runtime-library-members"></a><span data-ttu-id="a0570-103">Visual Basic 运行库成员</span><span class="sxs-lookup"><span data-stu-id="a0570-103">Visual Basic Runtime Library Members</span></span>

<span data-ttu-id="a0570-104">`Microsoft.VisualBasic`命名空间包含构成 Visual Basic 运行时库的类、模块、常量和枚举。</span><span class="sxs-lookup"><span data-stu-id="a0570-104">The `Microsoft.VisualBasic` namespace contains the classes, modules, constants, and enumerations that constitute the Visual Basic runtime library.</span></span> <span data-ttu-id="a0570-105">这些库成员提供您可以在代码中使用的过程、属性和常量值。</span><span class="sxs-lookup"><span data-stu-id="a0570-105">These library members provide procedures, properties, and constant values you can use in your code.</span></span> <span data-ttu-id="a0570-106">每个模块和类表示一种特定的功能类别。</span><span class="sxs-lookup"><span data-stu-id="a0570-106">Each module and class represents a particular category of functionality.</span></span>  
  
## <a name="microsoftvisualbasiccollection-class"></a><span data-ttu-id="a0570-107">Microsoft. 集合类</span><span class="sxs-lookup"><span data-stu-id="a0570-107">Microsoft.VisualBasic.Collection Class</span></span>  
...
## <a name="microsoftvisualbasiccomclassattribute-class"></a><span data-ttu-id="a0570-108">ComClassAttribute 类</span><span class="sxs-lookup"><span data-stu-id="a0570-108">Microsoft.VisualBasic.ComClassAttribute Class</span></span>  
...
## <a name="microsoftvisualbasiccontrolchars-class"></a><span data-ttu-id="a0570-109">ControlChars 类</span><span class="sxs-lookup"><span data-stu-id="a0570-109">Microsoft.VisualBasic.ControlChars Class</span></span>  
...
## <a name="microsoftvisualbasicconstants-class"></a><span data-ttu-id="a0570-110">Microsoft. 常量类</span><span class="sxs-lookup"><span data-stu-id="a0570-110">Microsoft.VisualBasic.Constants Class</span></span>  
...
## <a name="microsoftvisualbasicconversion-module"></a><span data-ttu-id="a0570-111">Microsoft. 转换模块</span><span class="sxs-lookup"><span data-stu-id="a0570-111">Microsoft.VisualBasic.Conversion Module</span></span>  
...
## <a name="microsoftvisualbasicdateandtime-module"></a><span data-ttu-id="a0570-112">Formatting.dateandtime.custom 模块</span><span class="sxs-lookup"><span data-stu-id="a0570-112">Microsoft.VisualBasic.DateAndTime Module</span></span>  
...
## <a name="microsoftvisualbasicerrobject-class"></a><span data-ttu-id="a0570-113">ErrObject 类</span><span class="sxs-lookup"><span data-stu-id="a0570-113">Microsoft.VisualBasic.ErrObject Class</span></span>  
...
## <a name="microsoftvisualbasicfilesystem-module"></a><span data-ttu-id="a0570-114">Microsoft. 文件系统模块</span><span class="sxs-lookup"><span data-stu-id="a0570-114">Microsoft.VisualBasic.FileSystem Module</span></span>  
...
## <a name="microsoftvisualbasicfinancial-module"></a><span data-ttu-id="a0570-115">Microsoft. 金融模块</span><span class="sxs-lookup"><span data-stu-id="a0570-115">Microsoft.VisualBasic.Financial Module</span></span>  
...
## <a name="microsoftvisualbasicglobals-module"></a><span data-ttu-id="a0570-116">Microsoft. Globals 模块</span><span class="sxs-lookup"><span data-stu-id="a0570-116">Microsoft.VisualBasic.Globals Module</span></span>  
...
## <a name="microsoftvisualbasichidemodulenameattribute-class"></a><span data-ttu-id="a0570-117">HideModuleNameAttribute 类</span><span class="sxs-lookup"><span data-stu-id="a0570-117">Microsoft.VisualBasic.HideModuleNameAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.HideModuleNameAttribute>||||  
  
## <a name="microsoftvisualbasicinformation-module"></a><span data-ttu-id="a0570-118">Microsoft. 信息模块</span><span class="sxs-lookup"><span data-stu-id="a0570-118">Microsoft.VisualBasic.Information Module</span></span>  
...
## <a name="microsoftvisualbasicinteraction-module"></a><span data-ttu-id="a0570-119">Microsoft。</span><span class="sxs-lookup"><span data-stu-id="a0570-119">Microsoft.VisualBasic.Interaction Module</span></span>  
...
## <a name="microsoftvisualbasicmygroupcollectionattribute-class"></a><span data-ttu-id="a0570-120">MyGroupCollectionAttribute 类</span><span class="sxs-lookup"><span data-stu-id="a0570-120">Microsoft.VisualBasic.MyGroupCollectionAttribute Class</span></span>  
...
## <a name="microsoftvisualbasicstrings-module"></a><span data-ttu-id="a0570-121">Microsoft. 字符串模块</span><span class="sxs-lookup"><span data-stu-id="a0570-121">Microsoft.VisualBasic.Strings Module</span></span>  
...
## <a name="microsoftvisualbasicvbfixedarrayattribute-class"></a><span data-ttu-id="a0570-122">VBFixedArrayAttribute 类</span><span class="sxs-lookup"><span data-stu-id="a0570-122">Microsoft.VisualBasic.VBFixedArrayAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Bounds%2A>|<xref:Microsoft.VisualBasic.VBFixedArrayAttribute.Length%2A>|||  
  
## <a name="microsoftvisualbasicvbfixedstringattribute-class"></a><span data-ttu-id="a0570-123">VBFixedStringAttribute 类</span><span class="sxs-lookup"><span data-stu-id="a0570-123">Microsoft.VisualBasic.VBFixedStringAttribute Class</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBFixedStringAttribute.Length%2A>||||  
  
## <a name="microsoftvisualbasicvbmath-module"></a><span data-ttu-id="a0570-124">VbMath 模块</span><span class="sxs-lookup"><span data-stu-id="a0570-124">Microsoft.VisualBasic.VbMath Module</span></span>  
  
|||||  
|---|---|---|---|  
|<xref:Microsoft.VisualBasic.VBMath.Randomize%2A>|<xref:Microsoft.VisualBasic.VBMath.Rnd%2A>|||  
  
## <a name="microsoftvisualbasic-constants-and-enumerations"></a><span data-ttu-id="a0570-125">Microsoft。</span><span class="sxs-lookup"><span data-stu-id="a0570-125">Microsoft.VisualBasic Constants and Enumerations</span></span>  

 <span data-ttu-id="a0570-126">`Microsoft.VisualBasic`命名空间提供常量和枚举作为 Visual Basic 运行时库的一部分。</span><span class="sxs-lookup"><span data-stu-id="a0570-126">The `Microsoft.VisualBasic` namespace provides constants and enumerations as part of the Visual Basic run-time library.</span></span> <span data-ttu-id="a0570-127">你可以在代码中使用这些常量值。</span><span class="sxs-lookup"><span data-stu-id="a0570-127">You can use these constant values in your code.</span></span> <span data-ttu-id="a0570-128">每个枚举表示一种特定的功能类别。</span><span class="sxs-lookup"><span data-stu-id="a0570-128">Each enumeration represents a particular category of functionality.</span></span> <span data-ttu-id="a0570-129">有关详细信息，请参阅 [常量和枚举](constants-and-enumerations.md)。</span><span class="sxs-lookup"><span data-stu-id="a0570-129">For more information, see [Constants and Enumerations](constants-and-enumerations.md).</span></span>  
  
## <a name="see-also"></a><span data-ttu-id="a0570-130">请参阅</span><span class="sxs-lookup"><span data-stu-id="a0570-130">See also</span></span>

- [<span data-ttu-id="a0570-131">常量和枚举</span><span class="sxs-lookup"><span data-stu-id="a0570-131">Constants and Enumerations</span></span>](constants-and-enumerations.md)
- [<span data-ttu-id="a0570-132">关键字</span><span class="sxs-lookup"><span data-stu-id="a0570-132">Keywords</span></span>](keywords/index.md)
