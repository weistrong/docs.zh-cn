...
---
# <a name="member-membername-implicitly-defines-a-member-implicitmembername-which-has-the-same-name-as-a-type-parameter"></a>成员“\<implicitmembername>”隐式定义了与某个类型形参同名的成员“\<membername>”
