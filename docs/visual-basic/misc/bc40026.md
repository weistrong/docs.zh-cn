...
---
# <a name="classname-is-not-cls-compliant-because-it-derives-from-baseclassname-which-is-not-cls-compliant"></a>" \<classname> " 不符合 cls，因为它是从不符合 cls 的 "" 派生的 \<baseclassname>
